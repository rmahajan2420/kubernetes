...
/usr/local/bin/aws ec2 create-tags --region 'ap-southeast-1' --resources $INSTANCE_ID --tags "Key=Name,Value=fame-kubernetes-prod-minion" "Key=Role,Value=fame-kubernetes-prod-minion" "Key=KubernetesCluster,Value=fame-kubernetes-prod"
