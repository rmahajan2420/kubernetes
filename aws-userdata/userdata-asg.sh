...
/usr/local/bin/aws ec2 create-tags --region 'us-east-1' --resources $INSTANCE_ID --tags "Key=Name,Value=fame-kubernetes-aws-minion	" "Key=Role,Value=fame-kubernetes-aws-minion" "Key=KubernetesCluster,Value=fame-kubernetes-aws"
